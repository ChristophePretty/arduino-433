...
#ifdef USE_WEBSOCKET
#define WIFI_SSID "troy"
#define WIFI_PASS "bastienraphaelle"
...
//  ELECHOUSE_cc1101.setMHZ(433.92); // Here you can set your basic frequency. The lib calculates the frequency automatically (default = 433.92).The cc1101 can: 300-348 MHZ, 387-464MHZ and 779-928MHZ. Read More info from datasheet.
  ...
  Serial.println("CC1101 Setup done");
#endif

#ifdef USE_ESPILIGHT
  Serial.println("ESPILIGHT Setup");
  rf.setCallback(espiCallback);
  rf.initReceiver(RC_INPUT_PIN);
  Serial.println("ESPILIGHT Setup done");
#else
  Serial.println("RCSWITCH Setup");
  mySwitch.enableReceive(digitalPinToInterrupt(RC_INPUT_PIN));
  mySwitch.enableTransmit(RC_OUTPUT_PIN);
  mySwitch.setRepeatTransmit(8);
  Serial.println("RCSWITCH Setup done");
#endif
